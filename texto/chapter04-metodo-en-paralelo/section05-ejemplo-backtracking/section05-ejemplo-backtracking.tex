...
\begin{figure}[H]
    ...
    \caption[Backtracking paralelo: Paso 8 - Primera subsecuencia completa (BDAB)]{Octavo paso del backtracking, la rama 1 llega a una celda con valor 0, por lo que detiene su exploración y agrega el patrón completo \texttt{BDAB} a los resultados finales. Las otras ramas continúan explorando.}
    \end{figure}
...
\begin{figure}[H]
    ...
    \caption[Backtracking paralelo: Paso 10 - Segunda subsecuencia completa (BCAB)]{Décimo paso del backtracking, la rama 2 llega a una celda con valor 0, deteniendo su exploración y agregando el patrón completo \texttt{BCAB} a los resultados finales. Las ramas restantes continúan explorando.}
    \end{figure}
...
\begin{figure}[H]
    ...
    \caption[Backtracking paralelo: Paso 12 - Subsecuencias finales (BCBA y BABA)]{Ultimo paso del backtracking, las ramas 3 y 4 llegan a una celda con valor 0, deteniendo su exploración y agregando los patrones completos \texttt{BCBA} y \texttt{BABA} a los resultados finales.}
    \end{figure}
