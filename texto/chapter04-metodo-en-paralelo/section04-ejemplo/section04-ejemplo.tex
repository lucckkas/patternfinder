...
\begin{figure}[H]
    ...
    \caption[Ejemplo paralelo: Diagonal 2 (2 celdas)]{Procesamiento de la diagonal 2, con dos celdas que se pueden completar en paralelo. (H1 y H2)}
    \end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Par_example/Par_example_04.png}
    \caption[Ejemplo paralelo: Diagonal 3 (3 celdas)]{Procesamiento de la diagonal 3, con tres celdas que se pueden completar en paralelo. (se crea H3)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Par_example/Par_example_05.png}
    \caption[Ejemplo paralelo: Diagonal 4 (4 celdas)]{Procesamiento de la diagonal 4, con cuatro celdas que se pueden completar en paralelo. (se crea H4)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Par_example/Par_example_06.png}
    \caption[Ejemplo paralelo: Diagonal 5 (5 celdas)]{Procesamiento de la diagonal 5, con cinco celdas que se pueden completar en paralelo. (se crea H5)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Par_example/Par_example_07.png}
    \caption[Ejemplo paralelo: Diagonal 6 (6 celdas)]{Procesamiento de la diagonal 6, con seis celdas que se pueden completar en paralelo. (se crea H6)}
    \end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Par_example/Par_example_08.png}
    \caption[Ejemplo paralelo: Diagonal 7 (7 celdas)]{Procesamiento de la diagonal 7, con siete celdas que se pueden completar en paralelo. (se crea H7)}
    \end{figure}
...
\begin{figure}[H]
    ...
    \caption[Ejemplo paralelo: Diagonal 10 (6 celdas)]{Procesamiento de la diagonal 10, como ya se superó el largo de la secuencia 1, solo hay seis celdas a procesar en paralelo. (H1 termina su trabajo)}
    \end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Par_example/Par_example_12.png}
    \caption[Ejemplo paralelo: Diagonal 11 (5 celdas)]{Procesamiento de la diagonal 11, con cinco celdas que se pueden completar en paralelo. (H2 termina su trabajo)}
    \end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Par_example/Par_example_13.png}
    \caption[Ejemplo paralelo: Diagonal 12 (4 celdas)]{Procesamiento de la diagonal 12, con cuatro celdas que se pueden completar en paralelo. (H3 termina su trabajo)}
    \end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Par_example/Par_example_14.png}
    \caption[Ejemplo paralelo: Diagonal 13 (3 celdas)]{Procesamiento de la diagonal 13, con tres celdas que se pueden completar en paralelo. (H4 termina su trabajo)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Par_example/Par_example_15.png}
    \caption[Ejemplo paralelo: Diagonal 14 (2 celdas)]{Procesamiento de la diagonal 14, con dos celdas que se pueden completar en paralelo. (H5 termina su trabajo)}
    \end{figure}
