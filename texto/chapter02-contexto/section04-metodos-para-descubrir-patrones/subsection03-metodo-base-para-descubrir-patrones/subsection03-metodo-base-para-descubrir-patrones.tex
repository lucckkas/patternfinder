...
Este trabajo se inspira en una propuesta secuencial, que emplea un método exhaustivo de generación de subsecuencias para identificar patrones. El algoritmo original opera mediante tres etapas principales:
...
Este patrón captura la coincidencia de \texttt{A}, \texttt{C} y \texttt{D}, con una brecha (gap) correspondiente a la diferencia entre \texttt{B} y \texttt{H}.
