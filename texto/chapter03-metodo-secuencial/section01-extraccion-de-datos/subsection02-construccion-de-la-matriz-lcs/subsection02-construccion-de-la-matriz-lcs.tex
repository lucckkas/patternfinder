...
Para cada par de segmentos que interactúan con un ligando se construye una matriz $(n+1) \times (m+1)$ que almacena la longitud de la \textit{Longest Common Subsequence} entre los prefijos de ambas cadenas. La recurrencia empleada es la siguiente:
