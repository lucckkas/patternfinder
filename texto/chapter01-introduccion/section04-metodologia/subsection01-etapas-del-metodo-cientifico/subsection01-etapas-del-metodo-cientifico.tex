...
\paragraph{Análisis de resultados} Los datos obtenidos durante la experimentación se anali-zarán para verificar si la paralelización cumple con las expectativas de mejora de rendimiento. Se compararán los tiempos de ejecución y el uso de recursos entre la versión secuencial y la paralela.
